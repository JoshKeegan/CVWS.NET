 ...
 * CVWS.NET
 * libCvws
 * Optimised version of AForge.NET's GrahamConvexHull
 * Authors:
 *  Josh Keegan 17/04/2017
 * 
 * This code has been subitted as a PR to AForge.NET: https://github.com/andrewkirillov/AForge.NET/pull/22
 *  Once the improvements are incorporated into the library, this can be removed
 */
...
namespace libCVWS.AForgeAlgorithms
{
    /// <summary>
    ...
    /// </remarks>
    /// 
    public class OptimisedGrahamConvexHull : IConvexHullAlgorithm
    {
        /// <summary>
